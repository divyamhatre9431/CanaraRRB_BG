...
public class KCS1DataExtractionService {
	...
	public static void main(String[] args) throws IOException, SQLException {
		...
		amlProp.load(is);
		is.close();
		String procedure = amlProp.getProperty("KCS1_PL");
		
		try
		{
			makeConnection();
			
			RequestDataBean reqObj = ConstantFunctions.getRequestData("KCS1");
			...
			new Thread(new KCS1Thread(requestId, batchNo, fromDate, toDate, reportType,procedure)).start();
		}
		catch(Exception e)
		{
			e.printStackTrace();
