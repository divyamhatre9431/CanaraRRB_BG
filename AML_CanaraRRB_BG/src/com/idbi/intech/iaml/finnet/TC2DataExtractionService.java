...
public class TC2DataExtractionService {
	...
	public static void main(String[] args) throws IOException, SQLException {
		...
		amlProp.load(is);
		is.close();
		String procedure = amlProp.getProperty("TC2_PL");
		
		try
		{
			makeConnection();
			
			RequestDataBean reqObj = ConstantFunctions.getRequestData("TC2");
			...
			new Thread(new TC2Thread(requestId, batchNo, fromDate, toDate, reportType,procedure)).start();
		}
		catch(Exception e)
		{
			e.printStackTrace();
