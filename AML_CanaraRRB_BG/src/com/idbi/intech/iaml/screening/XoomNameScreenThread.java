...
public class XoomNameScreenThread implements Runnable {
	...
	public void scanCustomer() {
		...
		try {
			...
			is = new FileInputStream(dir + "/aml-config.properties");
			amlProp.load(is);
			String inputFilePath = amlProp.getProperty("custpriorRequestPath");
			String processedPath = amlProp.getProperty("custpriorProcessed");
			String responsePath = amlProp.getProperty("custpriorResponsePath");
			...
			{
				cnt++;
				new Thread(new ScanningThread(reqFile, inputFilePath, processedPath, responsePath)).start();
	...
	public static void main(String args[]) {
		try {
			//makeConnection();
			Thread threadObj = new Thread(new XoomNameScreenThread());
			threadObj.start();
		} catch (Exception e) {
