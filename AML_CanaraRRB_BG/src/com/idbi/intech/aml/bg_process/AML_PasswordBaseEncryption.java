...
public class AML_PasswordBaseEncryption
{
    ...
    public AML_PasswordBaseEncryption()
        throws InvalidKeyException
    {
        this("iAML");
    }

    public AML_PasswordBaseEncryption(String s)
        throws InvalidKeyException
    {
        key = null;
    ...
    private void buildKey(String s)
        throws InvalidKeyException
    {
        String s1 = null;
        if(s.length() < 32)
    ...
    public String encrypt(String s)
    {
        ...
        for(int j = 0; j < i; j++)
        {
            AML_PasswordBaseEncryption IC_Outgoing_PasswordBaseEncryption = this;
            byte abyte2[] = AML_PasswordEncrypt.blockEncrypt(abyte0, j * 16, key);
    ...
    public String decrypt(String s)
    {
        ...
        {
            throw new RuntimeException("base64Decoder unable to decode ciphertext: " + ioexception.toString());
        }
        byte abyte1[] = new byte[abyte0.length];
        int i = abyte0.length / 16;
        for(int j = 0; j < i; j++)
        {
            AML_PasswordBaseEncryption IC_Outgoing_PasswordBaseEncryption = this;
            byte abyte2[] = AML_PasswordEncrypt.blockDecrypt(abyte0, j * 16, key);
            System.arraycopy(abyte2, 0, abyte1, j * 16, 16);
        }
    ...
    public static void main(String args[])
        throws Exception
    {
        AML_PasswordBaseEncryption IC_Outgoing_PasswordBaseEncryption = new AML_PasswordBaseEncryption();
        System.out.println(IC_Outgoing_PasswordBaseEncryption.decrypt("tmtivoS74+//Z8nYLjqhHw=="));
        String s = "Testing";
        String s1 = IC_Outgoing_PasswordBaseEncryption.encrypt(s);
        //System.out.println("Encrypting '" + s + "'");
        //System.out.println("Results in \n" + s1 + "\n");
        AML_PasswordBaseEncryption passwordbaseencryption1 = new AML_PasswordBaseEncryption("testpassword");
        System.out.println("Decrypted text '" + passwordbaseencryption1.decrypt(s1) + "'");
    }
